...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&duration=3000&pause=1000&color=70A5FD&center=true&vCenter=true&width=750&lines=Hey+there%2C+I'm+Anushiya+K+%F0%9F%91%8B;Full-Stack+MERN+Developer+%7C+CSE+Undergrad;400%2B+LeetCode+Problems+Solved+%F0%9F%94%A5;Building+Real-World+Web+Applications+%F0%9F%9A%80" alt="Typing SVG"/>
</div>
...
<details>
<summary><b>🏢 Rampex Company — MERN Stack Intern &nbsp;|&nbsp; 2025 &nbsp;|&nbsp; Tamil Nadu, India</b></summary>
...
- 🚀 Contributed to the development of **3+ full-stack web applications** using the MERN stack with seamless frontend-backend integration.
- 🔐 Designed and implemented **secure RESTful APIs** with **JWT-based authentication** for robust user session management.
- ⚡ Optimized state management using **React Hooks and Redux**, improving UI responsiveness by **30%**.
- 🔗 Ensured clean separation of concerns and modular architecture for maintainability and scalability.
...
|:---:|:---|:---|
| 🔥 | **LeetCode** | Max Rating **1571** · Solved **400+ problems** |
| 💡 | **CodeChef** | Solved **80+ problems** |
| ✅ | **HackerRank** | Problem Solving certified · Batches in **Java & SQL** |
| 🚀 | **Guidewire Hackathon** | Shortlisted to **Phase 3 (Pre-Final Round)** among top innovative teams *(2024)* |
| 🥈 | **Project Expo — 2nd Place** | *LEGAL RIGHTS ADVISOR* · Conducted in 2nd year *(2024)* |
| 🥈 | **Project Expo — 2nd Place** | *Hotel Management System* · C Buildathon · 1st year *(2023)* |
...
```
🧠 Deep Learning        →  Neural Networks, CNNs, RNNs (NVIDIA Certified)
☁️  AWS Cloud           →  Cloud Practitioner → Solutions Architect
🔢 Advanced DSA         →  Graphs, Dynamic Programming, Segment Trees
⚛️  React Ecosystem     →  Next.js, React Query, Advanced Patterns
🗄️  Databases           →  MongoDB Aggregation Pipelines, MySQL Optimization
```
...
| Crash Course in Data Science | Coursera | 2025 |
| MongoDB Course | Infosys Springboard | 2025 |
| Programming in Java *(Elite Certified)* | NPTEL – IIT Madras | 2024 |
| Learning React | Infosys Springboard | 2024 |
| Complete C Developer Course | Udemy | 2024 |
| Mastering DS & Algorithm using C and C++ | Udemy | 2024 |
...
<div align="center">
  <i>✨ "Code. Build. Solve. Repeat." — Anushiya K</i>
  <br/><br/>
  <a href="mailto:anushiya.kokila@gmail.com">
    <img src="https://img.shields.io/badge/Let's%20Connect!-anushiya.kokila%40gmail.com-70a5fd?style=for-the-badge&logo=gmail&logoColor=white"/>
  </a>
</div>
